(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("ReduxTs", ["mocha"], factory);
	else if(typeof exports === 'object')
		exports["ReduxTs"] = factory(require("mocha"));
	else
		root["ReduxTs"] = factory(root["mocha"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var asyncMiddleware_1 = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hasProperty = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var actionHelpers_1 = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var chai_1 = __webpack_require__(9);
	var storeBuilder_1 = __webpack_require__(7);
	var reducerBuilder_1 = __webpack_require__(24);
	var actionHelpers_1 = __webpack_require__(6);
	var SampleSyncAction = (function (_super) {
	    __extends(SampleSyncAction, _super);
	    function SampleSyncAction() {
	        _super.apply(this, arguments);
	    }
	    return SampleSyncAction;
	}(actionHelpers_1.SyncAction));
	var SampleAsyncAction = (function (_super) {
	    __extends(SampleAsyncAction, _super);
	    function SampleAsyncAction() {
	        _super.apply(this, arguments);
	    }
	    return SampleAsyncAction;
	}(actionHelpers_1.AsyncAction));
	describe("Reducer", function () {
	    describe("with inital state", function () {
	        var reducer = new reducerBuilder_1.ReducerBuilder()
	            .init({ isSyncActionCalled: true })
	            .build();
	        var store = new storeBuilder_1.StoreBuilder()
	            .withReducersMap({ reducer: reducer })
	            .build();
	        it("should have correct value", function () {
	            chai_1.expect(store.getState().reducer.isSyncActionCalled).equal(true);
	        });
	    });
	    describe("with sync action handler", function () {
	        var reducer = new reducerBuilder_1.ReducerBuilder()
	            .init({ isSyncActionCalled: false })
	            .handle(SampleSyncAction, function (state, action) {
	        ...
	        it("should be called on dispatch sync action", function () {
	            chai_1.expect(store.getState().reducer.isSyncActionCalled).equal(true);
	        });
	    });
	    describe("with async action handler", function () {
	        var dispatchedEvents = [];
	        var store;
	        var hookReducer = function (state, action) {
	        ...
	        before(function (done) {
	            var reducer = new reducerBuilder_1.ReducerBuilder()
	                ...
	                .handle(SampleAsyncAction, function (state, action) {
	                action.then(function (dispatch) {
	                ...
	                .build();
	            store = new storeBuilder_1.StoreBuilder()
	                .withReducersMap({ hookReducer: hookReducer, reducer: reducer })
	                .build();
	            store.dispatch(new SampleAsyncAction());
	        });
	        it("should dispatch actions in correct order", function () {
	            chai_1.expect(dispatchedEvents).deep.equal([
	                SampleAsyncAction.name,
	                SampleSyncAction.name,
	            ]);
	        });
	        it("should handle sync action", function () {
	            chai_1.expect(store.getState().reducer.isSyncActionCalled).equal(true);
	        });
	        it("should handle async action", function () {
	            chai_1.expect(store.getState().reducer.isAsyncActionCalled).equal(true);
	        });
	    });
	});
	...
	describe("Store", function () {
	    ...
	    describe("with inital state", function () {
	        var store = new storeBuilder_1.StoreBuilder()
	            ...
	            .build();
	        it("should have correct value", function () {
	            chai_1.expect(store.getState()).equal(initState);
	        });
	    });
	    describe("with middleware", function () {
	        var isSet = false;
	        var testMiddleware = function (store) { return function (next) { return function (action) { isSet = true; }; }; };
	        var store = new storeBuilder_1.StoreBuilder()
	            .withMiddleware(testMiddleware)
	            .withReducersMap({ reducer: reducer })
	            .build();
	        store.dispatch(TestAction);
	        it("should be called on dispatch action", function () {
	            chai_1.expect(isSet).equal(true);
	        });
	    });
	    ...
	    describe("with reducer map", function () {
	        var isSet = false;
	        var testReducer = function (state, action) {
	            if (state === void 0) { state = {}; }
	            if (action.type == TestAction.type) {
	        ...
	        var store = new storeBuilder_1.StoreBuilder()
	            .withReducersMap({ testReducer: testReducer })
	            .build();
	        store.dispatch(TestAction);
	        it("should be called on dispatch action", function () {
	            chai_1.expect(isSet).equal(true);
	    ...
	    describe("with enhancer", function () {
	        var isSet = false;
	        var enhancer = function (f) {
	            isSet = true;
	            return f;
	        };
	        var store = new storeBuilder_1.StoreBuilder()
...
/***/ function(module, exports, __webpack_require__) {
	...
	var transferFlags = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPathInfo = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.transferFlags = __webpack_require__(15);
	...
	exports.getPathInfo = __webpack_require__(12);
	
	/*!
	 * Check if a property exists
	 */
	
	exports.hasProperty = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Buffer;
	try { Buffer = __webpack_require__(8).Buffer; }
	catch(ex) {
	  Buffer = {};
